    ...
    <div className="min-h-screen flex flex-col transition-colors duration-500" style={{ backgroundColor: 'var(--bg-primary)' }}>
      ...
      <main className="flex-grow pt-20">
        <div className="min-h-[calc(100vh-80px)] flex">
          ...
          {/* Right side - Form */}
          <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-[#050816]">
            <div className="w-full max-w-md">
              ...
              <div className="mt-10 text-center">
                <p className="text-gray-500 text-sm">
                  ...
                  <Link 
                    to="/register" 
                    state={{ redirect: location.state?.redirect, planId: location.state?.planId }}
                    className="text-white font-semibold hover:text-[#8B5CF6]"
                  >
                    Registrarse
                  </Link>
                </p>
