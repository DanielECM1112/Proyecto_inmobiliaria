...
const SocialLinks = () => {
  ...
  const links = [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/luxhabitat.inmobiliaria',
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/luxhabitat.inmobiliaria',
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/luxhabitat',
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/company/luxhabitat-inmobiliaria',
  ...
  return (
    <div className={`social-card ${isDarkMode ? 'dark' : 'light'}`}>
      <ul>
        {links.map((link) => (
          <li key={link.name} className="iso-pro">
            <a
              href={link.href}
              target="_blank"
