...
export default function Navbar() {
  ...
  // Cerrar dropdown al dar click afuera
  useEffect(() => {
            ...
            <div className="relative" ref={menuRef}>
              ...
              {user ? (
                ...
                <>
                  ...
                  {/* Dropdown Usuario */}
                  <div
                    className={`absolute right-0 mt-4 w-64 bg-white rounded-2xl shadow-2xl py-4 transition-all duration-300 transform origin-top-right ${
                      showProfileMenu
                  ...
                  >
                    ...
                    <Link
                      to="/profile"
                      className="block px-6 py-3 text-gray-900 font-bold hover:bg-gray-50 transition-colors"
                    >
                      Mi Perfil
                    </Link>
                ...
                <Link
                  to="/auth"
                  className="flex items-center justify-center w-12 h-12 rounded-full bg-white/10 hover:bg-white/20 transition-all border border-white/20"
                >
