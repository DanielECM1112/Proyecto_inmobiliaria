...
class UsuarioService:
    ...
    def desactivar_usuario(usuario_id):
        """
        Realiza la desactivación lógica de un usuario y marca sus Propiedads como finalizados.
        """
        try:
            ...
            # Lógica de negocio adicional: Propiedads asociados pasan a estado 'finalizado'
            if hasattr(usuario, 'Propiedads'):
                usuario.Propiedads.all().update(estado='finalizado')
