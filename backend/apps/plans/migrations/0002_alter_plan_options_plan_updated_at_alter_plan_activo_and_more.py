...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='plan',
            name='max_imagenes',
            field=models.PositiveIntegerField(default=20, verbose_name='Máximo de Imágenes por Inmueble'),
        ),
        migrations.AlterField(
            model_name='plan',
            name='max_inmuebles',
            field=models.PositiveIntegerField(default=10, verbose_name='Máximo de Inmuebles'),
        ),
        migrations.AlterField(
            model_name='plan',
            name='nombre',
